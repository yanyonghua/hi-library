...
object HiStatusBar {
    ...
    fun setStatusBar(
        ...
        var visibility =decoreView.systemUiVisibility
        if (Build.VERSION.SDK_INT>= Build.VERSION_CODES.LOLLIPOP){
            //请求系统绘制状态栏的背景色 ,下面两个flag不能共存
